...
type StringValue = { current: string; valid?: boolean }
const maxprobe = {} as Partial<NumberValue>
const probefeedrate = {} as Partial<NumberValue>
const probethickness = {} as Partial<NumberValue>
