...
const generateValidationGlobal = (
    ...
    if (fieldData.shortkey && interfaceSettings) {
        ...
        if (fieldData.type === "text") {
            ...
            if (fieldData.min !== undefined) {
                const minValue = typeof fieldData.min === 'number' ? fieldData.min : parseInt(fieldData.min || '0')
            ...
            if (fieldData.max) {
                ...
                if (fieldData.value.trim().length > maxValue) {
                    validation.valid = false
                    console.log("Error")
                }
            }
            ...
            if (fieldData.min !== undefined) {
                ...
                } else if (fieldData.value < minValue) {
                    validation.valid = false
                    console.log("Error")
                }
            }
    ...
    if (
        (isFlashFS !== undefined || isSDFS !== undefined) &&
        setShowSave !== undefined &&
...
const InterfaceTab = () => {
    ...
    const generateValidation = (fieldData: FieldData): ValidationResult => {
            ...
            <div style="text-align: center">
                ...
                <ButtonImg
                    ...
                    onClick={(e: TargetedMouseEvent<HTMLButtonElement>) => {
                        ...
                        e.currentTarget.blur()
                        //console.log(interfaceSettings.current)
                        exportPreferences(interfaceSettings.current as InterfaceSettingsData)
                    }}
                />
                {showSave && (
                    <ButtonImg
